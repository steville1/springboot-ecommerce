...
import com.tastefultreasure.ecommerce.entity.User;
...
public class AuthServiceImplementation implements AuthService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        if(userRepository.existsByUsername(registerDto.getUsername())){
            throw new TasteFulTreasureException(HttpStatus.BAD_REQUEST, "Username is already exists!.");
        }

        // add check for email exists in database
        if(userRepository.existsByEmail(registerDto.getEmail())){
            throw new TasteFulTreasureException(HttpStatus.BAD_REQUEST, "Email is already exists!.");
        }
